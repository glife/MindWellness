...
const Signup = () => {
  ...
  const handleSubmit = () => {
    alert(isLogin ? "Login Successful! ✅" : "Signup Complete! 🎉");
    console.log(isLogin ? "Logging in user..." : "User Data:", formData);
  };

  return (
    <div
    className="flex justify-center items-center min-h-screen bg-cover bg-center bg-no-repeat px-6"
  ...
  >
    <div className="w-full max-w-lg shadow-lg rounded-3xl p-8 space-y-6 transform hover:scale-105 transition-transform duration-300 bg-black backdrop-blur-lg">
      ...
      <p
        ...
        className="text-sm text-white text-center cursor-pointer hover:underline mt-3"
      >
